...
Begin VB.Form Principal 
   ...
   Begin VB.Menu Reportes 
      ...
      Begin VB.Menu Consultar_Ord_Prov 
         Caption         =   "Consultar Ordenes/Proveedor"
      End
      Begin VB.Menu Consultar_Item_Orden 
         Caption         =   "Consultar Items/Orden"
      End
   End
   Begin VB.Menu Salir 
      Caption         =   "&Salir"
...
Private Sub Consultar_Ord_Prov_Click()
  Comando = "rwrun60 report=" & CurrentDir & "RELACION_ORDENES.rdf userid=" & CurrentUser
  ExeComando = Shell(Comando, vbNormalFocus)
End Sub

Private Sub Evaluar_Tiempo_Entrega_Click()
 Comando = "rwrun60 report=" & CurrentDir & "TIEMPO_ENTREGA_PROV.rdf userid=" & CurrentUser
  ExeComando = Shell(Comando, vbNormalFocus)
End Sub
...
Private Sub Form_Load()
  ...
  CurrentUser = "OPS$DESCOM02/OPS$DESCOM02@bd806"
End Sub
...
Private Sub Expediente_Click()
  Comando = "ifrun60 " & CurrentDir & "PROVEEDORESv2 " & CurrentUser
  ExeComando = Shell(Comando, vbMaximizedFocus)
End Sub
...
Private Sub Proveedores_Evaluacion_Click()
  ...
  Comando = "rwrun60 report=" & CurrentDir & "EVALUACIONv2.rdf userid=" & CurrentUser
  ExeComando = Shell(Comando, vbNormalFocus)
End Sub
