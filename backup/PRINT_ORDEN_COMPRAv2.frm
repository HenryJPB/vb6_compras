...
Private Sub LOAD_REQUISITOS_LEGALES(Numero_Orden As Variant, ByRef Requisitos() As String)
    ...
    ConnRec.Close
    Conn.Close
    'MsgBox "Tamaño de mi array=" + Str(UBound(Requisitos) - LBound(Requisitos) + 1)  ' Error.
...
'*
'****************************************************
Private Sub IMPRIMIR_REQ_LEGALES(ByRef Requisitos() As String, ByRef Contador As Integer)
   Dim K1 As Integer
   Dim K2 As Integer
            ...
            If (Not Reg.EOF) Then
                If (Reg("C2_NUMERO_ORDEN") <> Numero_Orden) Then
                     If (POSEE_REQ_LEGALES(Numero_Orden)) Then
                         ...
                         IMPRIMIR_REQ_LEGALES Requisitos, Contador
                         Contador = Contador + 2   '* Ajuste
                         AVANZAR_LINEAS Contador   '* Revisar Contador
                     Else
                         AVANZAR_LINEAS Contador
